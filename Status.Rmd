...
```{r,results="asis",eval=FALSE}
    #Athuga að ceiling er til þess að geta gert linear interpolation að lengd sem er deilanleg með 10 sjá næsta kafla. Ceiling á min er til þess að í MCMC keyrslunni fari ekki mínus tala inní log(W-c) þar sem c er hreyfanlegur stiki. Þetta getur verið vandamál samt, skoða nánari umræðu síðar.
