...
```{r,results="asis",eval=FALSE}
        ...
        #Gætir líka lent í veseni með interpolation töflurnar, þyrfti að skoða það. Gæti verið að betra sé að flytja þær úr model1BH fallinu en samt inn í          #model1( reactive fallinu)
